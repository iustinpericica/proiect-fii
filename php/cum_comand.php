...
<div class="container-fluid" id="textc" style="font-size: 25px;">
  ...
  <p>Daca te afli pe aceasta pagina, inseamna ca te intrebi cum comanzi</p>
  <p>Primul pas este sa iti faci un cont : <button id="fa_ticont" class="btn btn-default">Fa-ti cont</button></p>
  <p>Acum ca ti-ai facut un cont, </p>
  <p>Tot ce trebuie sa faci este sa mergi pe pagina magazinului, sa cauti produsele preferate, sa le adaugi in cos(la acesta ai acces apasand pe iconita din sus dreapta paginii );</p>
